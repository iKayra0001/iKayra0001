...
Utils.SmoothScroll = function(content, SmoothingFactor) -- by iKayra#0001
...
Utils.Notify(LocalPlayer, "Loaded", format("Kayra's pro script loaded in %.3f seconds", (tick()) - _L.start));
Utils.Notify(LocalPlayer, "Welcome, Script made by iKayra#0001", "'cmds' to see all of the commands, 'config' to customise the script");
if (debug.info(2, "f") == nil) then
    Utils.Notify(LocalPlayer, "Outdated Script", "You are using an outdated script. Please dm iKayra#0001 to fix it.", 10);
end
